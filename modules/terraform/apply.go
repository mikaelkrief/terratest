...
func ApplyE(t *testing.T, options *Options) (string, error) {
	return RunTerraformCommandE(t, options, FormatArgs(options, "apply", "-input=false", "-lock=true", "-auto-approve")...)
}
...
func TgApplyAllE(t *testing.T, options *Options) (string, error) {
	...
	return RunTerraformCommandE(t, options, FormatArgs(options, "apply-all", "-input=false", "-lock=true", "-auto-approve")...)
}
